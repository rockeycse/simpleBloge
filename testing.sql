...
-- Dumping structure for table testing.employee
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  UNIQUE KEY `employee_mobile_unique` (`mobile`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table testing.employee: ~1 rows (approximately)
DELETE FROM `employee`;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` (`id`, `name`, `email`, `mobile`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'rockey', 'rockeycse@gmail.com', '01738349723', '121326', '2323', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- Dumping data for table testing.migrations: ~5 rows (approximately)
